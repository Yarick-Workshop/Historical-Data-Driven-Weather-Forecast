...
{
    private static readonly (string Name, WeatherCharacteristics Flag)[] OrderedPairs =
    {
    ...
    private static readonly Dictionary<string, WeatherCharacteristics> StringToFlagMap =
        OrderedPairs.ToDictionary(pair => pair.Name, pair => pair.Flag, StringComparer.OrdinalIgnoreCase);

    private static readonly Dictionary<WeatherCharacteristics, string> FlagToStringMap =
        OrderedPairs.ToDictionary(pair => pair.Flag, pair => pair.Name);
    ...
    public static IReadOnlyList<string> ToStrings(WeatherCharacteristics characteristics)
    {
        ...
        var results = new List<string>(FlagToStringMap.Count);
